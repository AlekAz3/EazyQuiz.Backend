...
namespace EazyQuiz.Extensions
{
    ...
    public static class StringExtension
    {
        ...
        public static bool IsEqual(this string a, string b) => a == b;
        ...
        public static bool IsMoreEightSymbols(this string str) => str.Length >= 8;
        ...
        {
            var result = str.Where(letter =>
                    Numeric.Contains(letter) || AlphabetLowerCase.Contains(letter) ||
                    AlphabetUpperCase.Contains(letter))
                .ToList();
